...
With a tight 8 month timeline and a core team of 5 graduate students, we set out to develop what we dubbed as a “souls-like in an evening”: A short experience that capturing the depth and tension of a full-length souls-like game. This required a carefully balanced production, where systems for tactical combat, world exploration, enemy variety, and progression all work in tandem.

For this project to scale to a full release, I needed to architect systems that empowered all developers to contribute independently, avoid bottleencks, and maintain a clean, scalable code as the project evolved.
...
- Nominated for Technical Excellence at [RPI GameFest](https://gamehub.rpi.edu/gamefest-2025) 
