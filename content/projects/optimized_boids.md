...
tags: ["C#", "AI Systems", "Gameplay AI", "Performance Optimization", "Simulation", "Behavior Programming"]
summary: "A boid simulation with obstacle avoidance, designer-friendly pathing, and optimized for a game embedded in the web browser."
cover:
...
Simple flocking algorithms struggle with obstacle avoidance and performance in real-time environments. My goal was to build a performant, extensible simulation capable of avoiding collisions, reacting to environmental bounds, enabling designer control, and maintaining behavior that could be easily intuited by the player.
